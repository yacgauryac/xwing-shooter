...
LEVELS = {
    1: {
        ...
        "bg_color": (0, 0, 0),
        "enemies": ["TIEFighter", "TIEInterceptor"],
        "spawn_distance": 150,
    },
    2: {
        "name": "DEEP SPACE",
        "waves": 4,
        "intro_text": "More hostiles incoming... stay sharp!",
        "bg_color": (0.01, 0.01, 0.02),
        "enemies": ["TIEFighter", "TIEInterceptor", "TIEBomber"],
        "spawn_distance": 140,
    },
    3: {
        "name": "NEBULA",
        "waves": 5,
        "intro_text": "Visibility is low... sensors jammed.",
    ...
    4: {
        ...
        "waves": 5,
        "intro_text": "Stay on target... STAY ON TARGET!",
